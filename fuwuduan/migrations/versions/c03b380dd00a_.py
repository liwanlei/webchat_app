...
Revision ID: c03b380dd00a
Revises: 95f573fea691
Create Date: 2018-06-03 15:15:34.166772
...
def upgrade():
    ...
    op.add_column('goods', sa.Column('desc', sa.String(), nullable=True))
